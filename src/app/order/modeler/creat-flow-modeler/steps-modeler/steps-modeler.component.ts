...
import { DataService } from 'src/app/order/data.service';
...
import { StepDto1 } from 'src/app/common/models/step-dto';
...
@Component({
  selector: 'app-steps-modeler',
  templateUrl: './steps-modeler.component.html',
  styleUrls: ['./steps-modeler.component.css']
})
export class StepsModelerComponent  implements OnInit{
...
numRole :number = 1;
  ...
  createRule() :void {
    this.router.navigate(['/mfe-rule-modeler'], { queryParams: { idStep: this.idStep }});
  }
...
listRule:Rule[]=[]
  ...
  viewAddRule(){
    ...
    this.router.navigate(['/mfe1/modeler/MfeRuleModeler']);
