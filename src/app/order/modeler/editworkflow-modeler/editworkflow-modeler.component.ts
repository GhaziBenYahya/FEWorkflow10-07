...
@Component({
  selector: 'app-editworkflow-modeler',
  templateUrl: './editworkflow-modeler.component.html',
  styleUrls: ['./editworkflow-modeler.component.css']
})
export class EditworkflowModelerComponent implements OnInit{
  ...
  editWorkflow2(){
    ...
    .subscribe(
      ...
      this.router.navigate(['/mfe1/modeler/creatFlowModelerComponent/'+ this.workflowId]);
    },
    (err) => {
      console.log(err)
